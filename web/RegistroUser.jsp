			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="RegistroServlet" method="POST">
					...
					<div class="contact100-form-checkbox">
                                            <font color="white"><h6>Business account (additional cost)</h6></font>
                                        <br> 
                                        <input type="radio" name = "rb" value="true" <h6><font color="white"> Yes</font></h6 > 
                                        <hr>
                                        <input type="radio" name = "rb" value="false" <h6><font color="white"> No</font></h6>
						<hr>
					</div>
